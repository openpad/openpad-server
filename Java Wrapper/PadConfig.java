...
public class PadConfig extends Serializable {
  ...
  public SWIGTYPE_p_Value serializeJSON() {
    return new SWIGTYPE_p_Value(openpadJNI.PadConfig_serializeJSON(swigCPtr, this), false);
  }
  ...
  public static PadConfig joystickWithButtonsLayout() {
    return new PadConfig(openpadJNI.PadConfig_joystickWithButtonsLayout(), true);
  }
